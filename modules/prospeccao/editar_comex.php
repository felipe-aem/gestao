...
$id = $_GET['id'] ?? null;
if (!$id) {
    header('Location: comex.php?erro=id_invalido');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        header('Location: visualizar_comex.php?id=' . $id . '&sucesso=1');
        exit;
...
<div class="form-container">
    <div class="page-header">
        <h1>✏️ Editar Prospecto - COMEX</h1>
        <a href="visualizar_comex.php?id=<?= $id ?>" class="btn btn-secondary">
            ← Voltar
        </a>
    </div>
...
echo renderLayout('Editar Prospecto - COMEX', $conteudo, 'prospeccao');
?>