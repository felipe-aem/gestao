    ...
    <div class="page-header no-print">
        <div class="header-top">
            ...
            <div class="header-actions">
                <a href="relatorios_print_tax.php?<?= http_build_query($_GET) ?>" target="_blank" class="btn btn-primary">
                    🖨️ Versão para Impressão
                </a>
                <button onclick="exportarExcel()" class="btn btn-success">
                    📥 Exportar Excel
                </button>
                <a href="tax.php" class="btn btn-primary">
                    ← Voltar ao Kanban
                </a>
            </div>
        </div>
        ...
        <div class="filters-section">
            <form method="GET" action="">
                ...
                <div class="filter-actions">
                    ...
                    <a href="relatorio_tax.php" class="btn-clear">✖️ Limpar</a>
                </div>
            </form>
        </div>
    </div>
