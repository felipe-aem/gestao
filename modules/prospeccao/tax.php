    ...
    <div class="header-title">
        ...
        <div class="header-actions">
            ...
            <?php if ($pode_criar_editar): ?>
                <a href="novo_tax.php" class="btn-primary">
                    ➕ Novo Prospecto
                </a>
            <?php endif; ?>
            <a href="relatorio_tax.php" class="btn-secondary">
                📈 Relatórios
            </a>
        </div>
    </div>
    ...
    <div class="filters-section">
        <form method="GET" action="">
            ...
            <div class="filter-actions">
                ...
                <a href="tax.php" class="btn-clear">✖️ Limpar</a>
            </div>
        </form>
    </div>
</div>
                ...
                <?php foreach ($prospectos_fase as $prospecto): ?>
                    <div class="kanban-card" data-id="<?= $prospecto['id'] ?>">
                        ...
                        <div class="card-actions">
                            <a href="visualizar_tax.php?id=<?= $prospecto['id'] ?>" class="btn-card btn-view">
                                👁️ Ver
                            </a>
                            <?php if ($pode_criar_editar): ?>
                                <a href="editar_tax.php?id=<?= $prospecto['id'] ?>" class="btn-card btn-edit">
                                    ✏️ Editar
                                </a>
                            <?php endif; ?>
                        </div>
