...
<head>
    ...
    <title>Novo Usuário - SIGAM</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="form-container">
                <form action="process_novo.php" method="POST">
                    <div class="form-grid">
                        ...
                        <div class="form-group full-width">
                            <div class="checkbox-group">
                                <input type="checkbox" id="visualiza_publicacoes_nao_vinculadas" name="visualiza_publicacoes_nao_vinculadas" value="1">
